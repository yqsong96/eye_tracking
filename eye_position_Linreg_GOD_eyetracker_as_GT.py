...
analysis_basename = 'eye_position_Linreg_GOD_eyetracker_as_GT.py'
...
def select_training_data(data, training_data_label,eyetracker):
   # selector for training:
    x_long, xpos_long, ypos_long = select_label(data, cond_type, dir_type)
    xpos_long, ypos_long = eyetracker_GT(eyetracker)
...
# def eyetracker_GT(eyetracker,training_data_label):
#     if training_data_label == 'train_run1': 
#         select_x = np.logical_and(eyetracker["condition"]=="eyetracker_run1",
#                                 eyetracker["axis"]=="x")
#         x_pos = eyetracker[select_x]["predicted"]
#         select_y = np.logical_and(eyetracker["condition"]=="eyetracker_run1",
#                                 eyetracker["axis"]=="y")
#         y_pos = eyetracker[select_x]["predicted"]
#         return x_pos, y_pos
#     elif training_data_label == 'train_run2':
#         return x_1, xpos_1, ypos_1
#     else:
#         return x_2, xpos_2, ypos_2
def eyetracker_GT(eyetracker):
    select_x1 = np.logical_and(eyetracker["condition"]=="eyetracker_run1",
                                eyetracker["axis"]=="x")
    x_pos1 = eyetracker[select_x1].iloc[0]["predicted"]
    select_y1 = np.logical_and(eyetracker["condition"]=="eyetracker_run1",
                            eyetracker["axis"]=="y")
    y_pos1 = eyetracker[select_y1].iloc[0]["predicted"]
    
    select_x2 = np.logical_and(eyetracker["condition"]=="eyetracker_run2",
                                eyetracker["axis"]=="x")
    x_pos2 = eyetracker[select_x2].iloc[0]["predicted"]
    select_y2 = np.logical_and(eyetracker["condition"]=="eyetracker_run2",
                            eyetracker["axis"]=="y")
    y_pos2 = eyetracker[select_y2].iloc[0]["predicted"]
...
#     assert 1 == 0
    ...
    # get training data:
    x_tr, xpos_tr, ypos_tr = select_training_data(data_train, training_data_label,eyetracker)
    # change the label to eyetracker's value
